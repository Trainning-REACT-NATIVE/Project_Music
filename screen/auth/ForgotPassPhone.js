...
export default function SignIn() {
  ...
  const onChangePhone= (value) =>{
    //setstate(oldState=>({...oldState,username:value}));
    setEmail(value);
    //alert(value);
  }
  return (
    <ImageBackground source={image} style={styles.bgimage}>
      ...
      <StatusBar style="auto" />
        <Image
            ...
            source={require('C:/Users/Admin/my-app/image/image-security.png')}
          />
          <Text style={styles.text}>Forgot PassWord With Phone:</Text>
          <TextInput keyboardType={'number-pad'} style={styles.textIp} placeholder={"Phone"} onChangeText={onChangePhone} ></TextInput>
