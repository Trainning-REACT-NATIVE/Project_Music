...
export default function SignIn() {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.textIp2}>
        <Feather name="phone" size={25} color="#EDEDED" style={{ marginLeft: 5, }} />
        <TextInput keyboardType={'email-address'} style={{ marginLeft: 5, }} placeholder={"Phone"} placeholderTextColor={'#9B9B9B'} onChangeText={null} ></TextInput>
      </View>
      <View style={styles.textIp2}>
      ...
      <View style={styles.textIp2}>
        <Feather name="lock" size={25} color="#EDEDED" style={{ marginLeft: 5, }} />
        <TextInput secureTextEntry={securePassword} placeholder={"Re-enter Password"} placeholderTextColor={'#9B9B9B'} onChangeText={null} style={{ width: 185, marginLeft: 5, }}></TextInput>
        <TouchableOpacity onPress={onChangeSecure}><Feather name="eye" size={25} color="#EDEDED" /></TouchableOpacity>
      </View>
      <View style={{ justifyContent: 'space-between', alignItems: 'center',flex:1,marginBottom:15}}>
        ...
        <View style={{ flexDirection: 'row', marginBottom: 10 }}>
          <Text style={{ color: '#EDEDED', fontWeight: 'bold' }}>Already have an acount?</Text>
          <TouchableOpacity onPress={Login}><Text style={{ color: '#278EA5', fontWeight: 'bold' }}> Login</Text></TouchableOpacity>
        </View>
      </View>
    </View>
  );
